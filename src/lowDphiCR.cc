...
class lowDphiCR : public analyzer<RA2bNtuple> {

public :

  RA2bNtuple* ntuple;
  selectLowDphiCR<RA2bNtuple> *selectLdP;
  ...
  lowDphiCR( RA2bNtuple* ntuple_ , TString sampleTag_ , TString regionTag_ = "ldpCR" , 
    ...
    selectLdP = new selectLowDphiCR<RA2bNtuple>(ntuple,regionTag);
  ...
  void postProcess(){
    ...
    selectLdP->histo->Write("lowDphiCRYields_"+sampleTag);
